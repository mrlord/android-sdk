...
public abstract class BaseInterstitialActivity extends Activity {
    public static final String ACTION_INTERSTITIAL_FAIL = "com.adcash.action.interstitial.fail";
    public static final String ACTION_INTERSTITIAL_SHOW = "com.adcash.action.interstitial.show";
    public static final String ACTION_INTERSTITIAL_DISMISS = "com.adcash.action.interstitial.dismiss";
    public static final String ACTION_INTERSTITIAL_CLICK = "com.adcash.action.interstitial.click";
    ...
    protected void onDestroy() {
    	Log.d("Adcash", "Base Interstitial Activity Destroy has been called ");
      ...
      //  mCloseButton = new ImageButton(this);
        ...
        mCloseButton.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
            	Log.d("Adcash", "Closed Interstitial Button");
                finish();
            }
        });
   ...
   //     Toast.makeText(this, "Loaded interstitial ID " + Math.random(), Toast.LENGTH_LONG).show();
    }
